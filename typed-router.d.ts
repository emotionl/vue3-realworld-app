...
declare module 'vue-router/auto/routes' {
  ...
  export interface RouteNamedMap {
    ...
    'PlaygroundComponentsChild': RouteRecordInfo<'PlaygroundComponentsChild', '/playground/components/Child', Record<never, never>, Record<never, never>>,
    'PlaygroundComponentsClickEvent': RouteRecordInfo<'PlaygroundComponentsClickEvent', '/playground/components/ClickEvent', Record<never, never>, Record<never, never>>,
    'PlaygroundComponentsInputBinding': RouteRecordInfo<'PlaygroundComponentsInputBinding', '/playground/components/InputBinding', Record<never, never>, Record<never, never>>,
    'PlaygroundComponentsParent': RouteRecordInfo<'PlaygroundComponentsParent', '/playground/components/Parent', Record<never, never>, Record<never, never>>,
    'PlaygroundComponentsVariable': RouteRecordInfo<'PlaygroundComponentsVariable', '/playground/components/Variable', Record<never, never>, Record<never, never>>,
